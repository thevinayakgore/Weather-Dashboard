      ...
      <div className="flex flex-col lg:flex-row items-start justify-between w-full">
        ...
        >
          <CardHeader className="px-0">
            <CardTitle className="text-5xl md:text-7xl xl:text-8xl font-extrabold tracking-wide">
          ...
          <CardContent className="flex flex-col items-start px-0">
            ...
            <p className="text-lg sm:text-xl mt-2 mb-4 font-medium tracking-wide">
        ...
        >
          {getWeatherIcon(weatherData.condition, "size-60 sm:size-72 lg:size-80")}
          ...
          {weatherData.forecast.map((day, index) => (
            ...
            >
              <CardContent className="flex flex-col items-center m-auto w-full">
                ...
                {getWeatherIcon(day.condition, "size-24 lg:size-40")}
